  ...
  const handleSave = () => {
    ...
    updateMutation.mutate({
      ...
      personalityDimensions: {
        extroversion: dimensions['extroversion'] ?? 0.5,
        trust: dimensions['trust'] ?? 0.5,
        leadership: dimensions['leadership'] ?? 0.5,
        optimism: dimensions['optimism'] ?? 0.5,
        confidence: dimensions['confidence'] ?? 0.5,
        empathy: dimensions['empathy'] ?? 0.5,
        cautious: dimensions['cautious'] ?? 0.5,
        patience: dimensions['patience'] ?? 0.5,
        orderly: dimensions['orderly'] ?? 0.5,
        altruism: dimensions['altruism'] ?? 0.5,
      },
      traits,
      values,
