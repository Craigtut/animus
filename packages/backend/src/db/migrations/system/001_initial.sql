...
CREATE TABLE IF NOT EXISTS system_settings (
  ...
  thought_retention_days INTEGER NOT NULL DEFAULT 14,
  experience_retention_days INTEGER NOT NULL DEFAULT 14,
  emotion_history_retention_days INTEGER NOT NULL DEFAULT 14,
  agent_log_retention_days INTEGER NOT NULL DEFAULT 7,
