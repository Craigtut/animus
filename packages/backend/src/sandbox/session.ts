...
export class SandboxSession {
  ...
  constructor(manager: AgentManager, noPlugins: boolean) {
  ...
  async create(
    ...
    if (!this.noPlugins) {
      ...
      config.mcpServers = { ...pluginMcp };
      config.allowedTools = [...pluginTools];
    ...
    log.info('Creating sandbox session', { provider, model });
