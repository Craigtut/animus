...
describe('Tool Definitions', () => {
  it('should have 12 tool definitions', () => {
    expect(Object.keys(ANIMUS_TOOL_DEFS)).toHaveLength(12);
  });
...
describe('Tool Registry', () => {
  it('should return all tool names', () => {
    ...
    expect(names).toEqual(['send_message', 'update_progress', 'read_memory', 'lookup_contacts', 'send_proactive_message', 'send_media', 'run_with_credentials', 'list_vault_entries', 'manage_vault_entry', 'transcribe_audio', 'generate_speech', 'send_voice_reply']);
  });
