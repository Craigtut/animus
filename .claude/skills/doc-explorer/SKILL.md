...
## ⚠️ MANDATORY READING - ALWAYS LOAD FIRST
...
| File | Size | Covers |
|------|------|--------|
| `docs/agents/README.md` | 4 KB | Overview of agent SDK research, quick reference comparison table, key concerns, implementation priority (Claude first, Codex second, OpenCode third) |
| `docs/agents/01-claude-agent-sdk.md` | 14 KB | Claude Agent SDK deep dive - query() async generator, subprocess architecture, auth (API key or OAuth), session management, streaming, hooks, tools |
| `docs/agents/02-openai-codex-sdk.md` | 13 KB | Codex SDK - thread-based model, Codex class, startThread(), auth (ChatGPT OAuth or API key), no cancel/abort support |
| `docs/agents/03-opencode-sdk.md` | 12 KB | OpenCode SDK - client/server architecture, createOpencode(), session management, plugin system, 75+ providers |
| `docs/agents/04-architecture-overview.md` | 37 KB | Unified abstraction layer design - SDK comparison matrix, critical concerns (auth, streaming, sessions), design decisions, event normalization, built-in tools mapping |

### Extended SDK Research (Root-Level)

| File | Size | Covers |
|------|------|--------|
| `docs/Claude-Agent-SDK-Research.md` | 23 KB | Extended Claude Agent SDK research - authentication deep dive, core APIs, session management, streaming patterns, hooks, tool system, token/cost tracking, config options |
| `docs/opencode-sdk-research.md` | 27 KB | Extended OpenCode SDK research - client-server architecture, provider-agnostic design, core APIs, plugin system, extensibility |
| `docs/agents/openai-codex-sdk.md` | 25 KB | Extended Codex SDK research - installation, architecture, auth methods, session management, streaming, sandbox, token/cost tracking |
...
4. **For agent/SDK work**: Start with `docs/agents/README.md` for the overview, then read the specific SDK doc
...
- **heartbeat, tick, pipeline, mind session, inner life, emotion, decay, gather context** -> `docs/architecture/heartbeat.md`
...
- **claude sdk, agent sdk, anthropic, query, async generator** -> `docs/agents/01-claude-agent-sdk.md`
- **codex, openai, thread, codex sdk** -> `docs/agents/02-openai-codex-sdk.md`
- **opencode, provider-agnostic, client-server** -> `docs/agents/03-opencode-sdk.md`
- **abstraction layer, unified, event normalization, sdk comparison** -> `docs/agents/04-architecture-overview.md`
